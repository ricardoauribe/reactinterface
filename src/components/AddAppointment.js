...
const AddAppoitment = ({onSendAppointment, lastId}) => {
  ...
  let [toggleForm, setTotggleForm] = useState(false);
  ...
  function formDataPublish(){
    ...
    setTotggleForm(!toggleForm)
  }

  return (
    <div>
      <button onClick = {() => {setTotggleForm(!toggleForm)}} 
